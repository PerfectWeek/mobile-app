  ...
  async loginGoogle() {
    ...
    try {
      ...
      let res = await Google.logInAsync({
        iosClientId:
          "802613708270-g0fk0pqpke3m62fse0nt4qigppd5oje4.apps.googleusercontent.com",
        iosStandaloneAppClientId:
          "802613708270-kat25t9kln35o64cf8b031jjuekmi0of.apps.googleusercontent.com",
        androidClientId:
          "802613708270-m496pmo592dflj044c4hconf4deo56rh.apps.googleusercontent.com",
        androidStandaloneAppClientId:
          "802613708270-opv56tc6bha7frmet2gn8t54haep8rg0.apps.googleusercontent.com",
        scopes: [
      ...
      if (res.type === "success") {
        const auth = await ProviderService.ConnectWithGoogleTokens(
          res.accessToken,
          res.refreshToken
        );
