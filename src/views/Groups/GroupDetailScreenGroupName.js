    ...
    render() {
        ...
        return (
            <View style={{
                ...
                <Modal
                    canValidate={(this.state.EventTitle !== '' && this.props.groups.status !== GroupsActionType.EditGroupInfo)}
                    ...
                    this.props.EditGroupInfo({id: group.id, name: this.state.EventTitle, description: this.state.groupDescription})
                }}>
                    <View style={{
                        ...
                        <Form style={{
                            ...
                            <Item style={{marginTop: 0}}>
                                <Input placeholder="Group name" value={this.state.EventTitle}
