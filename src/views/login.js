...
import {Icon, View, Text, Button, Container, Content, Form, Item, Input, Card} from 'native-base';
...
class _LoginScreen extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.state = {username: 'pierre.said@epitech.eu', password: 'AmazingPassword42'};
    }

    render() {
        return (
            <View style={{height: Dimensions.get('window').height, paddingTop: Expo.Constants.statusBarHeight, backgroundColor: '#ffff'}}>
                <View style={{
                    justifyContent: 'center',
                    alignItems: 'center',
                }}>
                    <Image source={require('../../Resources/Image/logo_pw.png')}
                           style={{marginTop: 20, width: 100, height: 100}}/>
                </View>
                <Text style={{fontFamily: 'Lato_Bold', fontSize: 28, textAlign: 'center'}}>
                    PerfectWeek
                </Text>
                <Form style={{marginLeft: 10, marginRight: 30, marginTop:30}}>
                    ...
                    <Item style={{marginTop: 10}} error={!validateNotEmpty(this.state.password)}>
